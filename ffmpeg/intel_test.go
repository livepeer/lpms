...
func TestIntel_Transcoding(t *testing.T) {
...
func TestIntel_Transcoding_Multiple(t *testing.T) {
...
func TestIntel_Devices(t *testing.T) {
...
func TestIntel_DrainFilters(t *testing.T) {
...
func TestIntel_CountFrames(t *testing.T) {
	run, dir := setupTest(t)
	defer os.RemoveAll(dir)
...
func TestIntel_CountEncodedFrames(t *testing.T) {
	run, dir := setupTest(t)
	defer os.RemoveAll(dir)
