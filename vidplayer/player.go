...
var lpVersion = "undefined"

type VidPlayerDebugInfo struct {
	DebugEnabled	bool
...
func NewVidPlayer(rtmpS *joy4rtmp.Server, vodPath string, mux *http.ServeMux, httpDebugOpts VidPlayerDebugInfo) *VidPlayer {
	if mux == nil {
	...
	if (httpDebugOpts.DebugEnabled) {
		setDebugHeaders(httpDebugOpts.LivepeerVersion)
	}
	return player
}
...
// SetDebugHeaders is used to set header properties on HTTP responses generated by a B or OT node.
// This is useful for debugging.
func setDebugHeaders(LivepeerVersion string) {
//	w.Header().Set("livepeer-version", LiverpeerVersion)
	lpVersion = LivepeerVersion
}
