...
// vars to tag http response headers w/ various
// debugging info
var (
	lpVersion string 
	orchEthAddr string 
...
func NewVidPlayer(rtmpS *joy4rtmp.Server, vodPath string, mux *http.ServeMux, httpDebugHeaders VidPlayerDebug) *VidPlayer {
	...
	setDebugHeaders(httpDebugHeaders)
	return player
}
...
func setDebugHeaders(httpDebugHeaders VidPlayerDebug) {
        if (!httpDebugHeaders.DebugEnabled) {
		return
	}
	lpVersion = httpDebugHeaders.LivepeerVersion
	orchEthAddr = httpDebugHeaders.OrchEthAddress
}
...
func handleLive(w http.ResponseWriter, r *http.Request,
	...
	w.Header().Set("Orchestrato-Eth-Address", orchEthAddr)
